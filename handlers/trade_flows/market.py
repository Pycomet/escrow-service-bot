...
class MarketShopFlow:
    ...
    async def handle_description(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        trade = TradeClient.open_new_trade(
            update.message, currency=trade_data["currency"], trade_type="MarketShop"
        )
                ...
                [
                    [
                        InlineKeyboardButton(
                            "📤 Share Shop", switch_inline_query=forward_text
                        )
                    ],
                    [InlineKeyboardButton("🔙 Back to Menu", callback_data="menu")],
                ]
            ...
            await query.edit_message_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "🔙 Back to Shops", callback_data="browse_shops"
                            )
                        ]
                    ]
                ),
        ...
        await query.edit_message_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "🛍️ Make Purchase", callback_data=f"purchase_{shop['_id']}"
                        )
                    ],
                    [
                        InlineKeyboardButton(
