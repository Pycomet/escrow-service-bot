...
async def rules_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("👥 Community Guidelines", callback_data="community_rules")],
            [InlineKeyboardButton(f"{EmojiEnums.BACK_ARROW.value} Back to Menu", callback_data=CallbackDataEnums.MENU.value)]
        ])
        
        await query.edit_message_text(rules_text, parse_mode="HTML", reply_markup=keyboard)
...
async def community_rules_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton(f"{EmojiEnums.SCROLL.value} Trading Rules", callback_data="rules")],
            [InlineKeyboardButton(f"{EmojiEnums.BACK_ARROW.value} Back to Menu", callback_data=CallbackDataEnums.MENU.value)]
        ])
        
        await query.edit_message_text(community_text, parse_mode="HTML", reply_markup=keyboard)
