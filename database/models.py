...
#     seller = relationship(
#         "User", uselist=False, primaryjoin="Trade.seller_id == User.id"
#     )
...
#             return "No Dispute"
#         else:
#             return "%s Last Dispute Created %s " % (
#                 self.dispute[-1].id,
#                 self.dispute[-1].created_at,
#             )
...
#     trade = relationship(
#         "Trade", uselist=False, primaryjoin="Dispute.trade_id == Trade.id"
#     )
