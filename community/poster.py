...
class CommunityPoster:
    ...
    async def post_to_channel(self, content: str, content_type: str = "general") -> bool:
        ...
        try:
            ...
            if message:
                ...
                await self._log_successful_post(content_type, cleaned_content, message.message_id)
            ...
            if "chat not found" in str(e).lower():
                logger.error("Channel not found. Check COMMUNITY_CHANNEL_ID configuration.")
    ...
    async def _log_successful_post(self, content_type: str, content: str, message_id: int):
        """Log successful post to database"""
        try:
            log_entry = {
...
#TestMessage #SystemCheck"""
            ...
            return {
                "success": False,
                "error": f"Error posting test message: {str(e)}"
            }
